...
{
    /// <inheritdoc />
    public partial class InitialP0Schema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TransactionPasswordHash = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityType = table.Column<string>(type: "varchar(80)", unicode: false, maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_BankAccounts_Balance", "[Balance] >= 0");
                    table.CheckConstraint("CK_BankAccounts_Currency", "[Currency] = 'VND'");
                    table.CheckConstraint("CK_BankAccounts_Number", "[AccountNumber] NOT LIKE '%[^0-9]%' AND LEN([AccountNumber]) = 10");
                    table.ForeignKey(
                        name: "FK_BankAccounts_CustomerProfiles_CustomerProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReferenceNo = table.Column<string>(type: "varchar(30)", unicode: false, maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_FinancialTransactions_Accounts", "([Type] = 'Transfer' AND [SourceAccountId] IS NOT NULL AND [SourceAccountId] <> [DestinationAccountId]) OR ([Type] = 'CashDeposit' AND [SourceAccountId] IS NULL)");
                    table.CheckConstraint("CK_FinancialTransactions_Amount", "[Amount] > 0");
                    table.ForeignKey(
                        name: "FK_FinancialTransactions_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FinancialTransactions_BankAccounts_DestinationAccountId",
                        column: x => x.DestinationAccountId,
                        principalTable: "BankAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FinancialTransactions_BankAccounts_SourceAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialTransactions_CreatedByUserId_IdempotencyKey",
                table: "FinancialTransactions",
                columns: new[] { "CreatedByUserId", "IdempotencyKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FinancialTransactions_DestinationAccountId_CreatedAtUtc",
                table: "FinancialTransactions",
                columns: new[] { "DestinationAccountId", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_FinancialTransactions_ReferenceNo",
                table: "FinancialTransactions",
                column: "ReferenceNo",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FinancialTransactions_SourceAccountId_CreatedAtUtc",
                table: "FinancialTransactions",
